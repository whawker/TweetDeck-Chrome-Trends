...
TD.extensions.Trends = function() {
    ...
    location = 23424975,
    filters = [],
    trendItem = '<article class="stream-item" style="min-height: 70px;"><div class="item-box item-content"><div class="tweet" style="padding-left: 0;"><header class="tweet-header"></header><div class="tweet-body"><p></p><footer></footer></div><i class="sprite tweet-dogear"></i></div></div></article>',
